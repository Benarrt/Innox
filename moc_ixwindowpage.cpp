...
QT_MOC_LITERAL(1, 13, 16), // "componentChanged"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 11), // "QQuickItem*"
QT_MOC_LITERAL(4, 43, 4), // "item"
QT_MOC_LITERAL(5, 48, 9), // "component"
QT_MOC_LITERAL(6, 58, 12) // "setComponent"

    },
    "IXWindowPage\0componentChanged\0\0"
...
void IXWindowPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<IXWindowPage *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (IXWindowPage::*)(QQuickItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&IXWindowPage::componentChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void IXWindowPage::componentChanged(QQuickItem * _t1)
{
