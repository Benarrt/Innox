...
QT_MOC_LITERAL(5, 54, 12), // "onUrlChanged"
QT_MOC_LITERAL(6, 67, 9), // "component"
QT_MOC_LITERAL(7, 77, 12) // "setComponent"

    },
    "IXWindowPageHeader\0componentChanged\0"
    "\0QQuickItem*\0item\0onUrlChanged\0component\0"
    "setComponent"
};
...
void IXWindowPageHeader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<IXWindowPageHeader *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (IXWindowPageHeader::*)(QQuickItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&IXWindowPageHeader::componentChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void IXWindowPageHeader::componentChanged(QQuickItem * _t1)
{
